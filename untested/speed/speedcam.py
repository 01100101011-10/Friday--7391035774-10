...
mypath = os.path.abspath(__file__)  # File name
...
userMotionFilePath = os.path.join(baseDir, "neural systems")
motionCode = False
...
class WebcamVideoStream:
   ...
   WEBCAM_HFLIP = True or WEBCAM_VFLIP = True
